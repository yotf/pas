...
describe('delete customer', async () => {
  it('should delete customer on success', async () => {
    const deleteSpy = vi
      .spyOn(axiosInstance, 'delete')
      .mockResolvedValueOnce({ data: mockedSettingsItem.id });

    const dispatch = getDispatch();
    const response = await dispatch(deleteCustomersThunk(mockedSettingsItem.id));
...
describe('post-put customer', async () => {
  it('should put customer when given id', async () => {
    const putSpy = vi
    ...
    const dispatch = getDispatch();
    const response = await dispatch(upsertCustomerThunk(mockedSettingsItem));
  ...
  it('should post customer when no id', async () => {
    const postSpy = vi
    ...
    const dispatch = getDispatch();
    const response = await dispatch(upsertCustomerThunk(mockedSettingsItemForPost));
